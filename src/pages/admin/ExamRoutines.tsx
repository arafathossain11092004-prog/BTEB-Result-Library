...
export default function AdminExamRoutines() {
  ...
  const [subjects, setSubjects] = useState([{ subjectName: '', subjectCode: '', date: '', time: '' }]);
  ...
  const handleAddSubjectField = () => {
    setSubjects([...subjects, { subjectName: '', subjectCode: '', date: '', time: '' }]);
  };
              ...
              {routines.length === 0 ? (
                ...
                routines.map(r => (
                  <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-gray-600">{r.department || 'N/A'}</td>
                    ...
                    <td className="py-3 px-4 text-gray-600">{r.date} <span className="text-gray-400">at</span> {r.time}</td>

...
import { Save, Loader2, Image as ImageIcon, Upload, ShieldCheck, Cog } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold font-heading text-gray-900">System Settings</h1>
          <p className="text-gray-500 text-sm mt-1">Manage global application settings and admins</p>
        </div>
      </div>
